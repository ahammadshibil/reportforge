  ...
  return (
    <div className="px-6 py-6 max-w-3xl mx-auto">
      ...
      <Card className="p-6 mt-4">
        ...
        <div className="text-sm font-medium">Email delivery (SendGrid)</div>
        <p className="text-xs text-muted-foreground mt-1">
          Add your SendGrid API key to send newsletters and reports automatically. The
          backend exposes a stub `/api/distribute` endpoint you can wire to your provider.
        </p>
        <div className="mt-3">
          <Label>SENDGRID_API_KEY</Label>
          <Input placeholder="SG.xxxxx" type="password" data-testid="input-sendgrid" disabled />
          <div className="text-xs text-muted-foreground mt-1">
            Set as a server env var on deploy. Front-end never stores secrets.
          </div>
        </div>
      </Card>
    </div>
